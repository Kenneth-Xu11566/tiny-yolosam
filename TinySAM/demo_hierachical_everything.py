...
images_list = [
    ('fig/picture1.jpg', 'hierarchical_picture1.png'),
    ('fig/picture2.jpg', 'hierarchical_picture2.png'),
    ('fig/picture3.jpg', 'hierarchical_picture3.png'),
]

for img_path, output_path in images_list:
